...
--
-- Table structure for table `newexpert`
--

CREATE TABLE `newexpert` (
  `eusername` varchar(100) NOT NULL,
  `password` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `newexpert`
--

INSERT INTO `newexpert` (`eusername`, `password`) VALUES
('iman', '123'),
('sara', '123'),
('umar', '123');
...
--
-- Table structure for table `newguser`
--

CREATE TABLE `newguser` (
...
--
-- Indexes for table `newexpert`
--
ALTER TABLE `newexpert`
  ADD PRIMARY KEY (`eusername`);

--
-- Indexes for table `newguser`
--
ALTER TABLE `newguser`
  ADD PRIMARY KEY (`gusername`);
