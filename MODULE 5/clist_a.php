...
<header class="header">
    ...
    <button type="button"><span  class="button__icon"><a href="creport_a.php?"><ion-icon name="file-tray-full-outline"></ion-icon></a></span></button><br><br></left>
             ...
             ?>
                <tr>
                    ...
                    <td><?php echo $complaint['Complaint_Date'] ?></td>
                     ...
                     <button type="button"><span  class="button__icon"><a href="cstatus.php?id=<?php echo $complaint['ComplaintID']; ?>"><ion-icon name="create-outline"></ion-icon></a></span></button>
                     <button type="button"><span  class="button__icon"><a href="cdelete_u.php?id=<?php echo $complaint['ComplaintID']; ?>"><ion-icon name="trash-outline"></ion-icon></a></span></button>
                    </td>
